...
export const jobs: Job[] = [
    ...
    },
    {
        ...
        aptitudes: ['Next.js', 'Driver Domain Design (DDD)', 'Arquitectura de software', 'React.js', 'Laravel', 'AWS'],
        description: 'Como Arquitecto de software en Innovaweb, fui responsable de diseñar e implementar soluciones de arquitectura de software utilizando herramientas como Next.js, React.js, Laravel y AWS. También tengo experiencia en el enfoque de Diseño de Dominio del Controlador (DDD) y mi labor era mantenerme actualizado en las últimas tendencias y tecnologías en el área.'
    },
    {
        ...
        aptitudes: ['Dirección de equipos de trabajo', 'Gestión ágil de proyectos', 'Scrum Master', 'Desarrollo de liderazgo', 'Metodologías ágiles'],
        description: 'Como Director de proyectos en Innovaweb, he sido responsable de dirigir y desarrollar equipos de trabajo y liderar la implementación de metodologías ágiles. Además, he tenido experiencia en la gestión ágil de proyectos y he sido Scrum Master en distintos proyectos. Mi objetivo principal es ayudar a mis equipos a alcanzar sus metas y objetivos a través de la promoción del liderazgo y la colaboración.'
    },
    {
        ...
        aptitudes: ['Laravel', 'PHP', 'React.js', 'MySQL', 'HTML', 'CSS', 'Git', 'Scrum', 'Metodologías ágiles'],
        description: 'Como Desarrollador Web en Innovaweb, una empresa de tecnología con sede en Chile, he tenido la oportunidad de trabajar en una amplia variedad de proyectos utilizando distintas tecnologías como Laravel, PHP, React.js, MySQL, HTML, CSS y Git. También he participe en proyectos que utilizan metodologías ágiles como Scrum.'
    },
    {
