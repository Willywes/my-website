const BoletasHonorarioYPrevision = () => {
    return (
        <div
            style={{
                // display: 'flex',
                ...
                margin: 'auto',
                fontFamily:
                    'ui-system, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif'
            }}>
            ...
            <ul>
                <li>
                    <p>
                        ...
                        Company downloaded by You on any electronic device, named Boletas de
                        Honorarios y Previsión
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Country</strong> refers to: Chile
                    </p>
                </li>
                <li>
                    <p>
                        <strong>Company</strong> (referred to as either "the Company", "We", "Us" or
                        "Our" in this Agreement) refers to Boletas de Honorarios y Previsión.
                    </p>
                </li>
                <li>
                    <p>
            ...
            <ul>
                <li>By email: alejandro.isla.c@gmail.com</li>
            </ul>
        </div>
    );
};

export default BoletasHonorarioYPrevision;
